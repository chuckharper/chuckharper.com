...
<head>
	<?php
		$description = 'This is a work of fiction, but I am convinced the following conversation could have actually happened at some point.';
		$title = 'Chuck Harper’s Tron Legacy Origin';
		include($_SERVER['DOCUMENT_ROOT'] . '/includes/head.php'); 
	?>
	<title><?php print($site_title); ?> | Tron Legacy Origin</title>
	
	<script src="/js/inside.js" type="text/javascript"></script>

</head>
<body id="body_about" class="inside_body">
	<div id="inside_wrapper"><div id="main_inside">
		<?php include($_SERVER['DOCUMENT_ROOT'] . '/includes/nav.php'); ?>
		<h2>The Origin of Tron Legacy</h2>
		<div class="intro tron">
			...
			<p><strong class="character_name">Michelle:</strong> Hello, this is Michelle.<img src="https://s3-us-west-1.amazonaws.com/chuckharper/images/tron_legacy_logo.png" alt="Tron Legacy" title="Tron Legacy" class="trailing_image" /></p>
			...
			<p><strong class="character_name">Michelle:</strong> Well, he is also obsessed with Electronica music. That high frequency random noise stuff that they play at dance clubs. Like Crystal Method, Prodigy, and lately he's been listen to a LOT of Daft Punk. It's driving me a little nuts.<img src="https://s3-us-west-1.amazonaws.com/chuckharper/images/tron_daft_punk.jpg" alt="Daft Punk" title="Daft Punk" class="trailing_image" /></p>
			...
			<p class="coda"><strong>Author's Note:</strong> A reimaging of <em>The Black Hole</em> is now in preproduction at Disney.</p>
		</div>
	</div></div>
